            ...
            <ul class="list-unstyled topbar-nav float-right mb-0"> 
                ...
                <li class="dropdown">
                    <a class="nav-link dropdown-toggle waves-effect waves-light nav-user pr-0" data-toggle="dropdown" href="#" role="button"
                        ...
                        <span class="ml-1 nav-user-name hidden-sm">Dr.Amelia <i class="mdi mdi-chevron-down"></i> </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu">
                        <li class="has-submenu">
                            ...
                            <ul class="submenu">  
                                <li><a href="../hospital/hospital-index.html"><i class="dripicons-meter"></i>Dashboard</a></li>                                  
                                <li class="has-submenu">
                                ...
                                <li><a href="../hospital/all-rooms.html"><i class="dripicons-home"></i>All Rooms</a></li>
                                <li><a href="../hospital/expenses.html"><i class="dripicons-document"></i>Expenses Report</a></li>
                                <li><a href="../hospital/departments.html"><i class="dripicons-view-thumb"></i>Departments</a></li>
                                <li><a href="../hospital/insurance-company.html"><i class="dripicons-rocket"></i>Insurance Company</a></li>
                                <li><a href="../hospital/events.html"><i class="dripicons-calendar"></i>Events</a></li>
                                <li><a href="../hospital/chat.html"><i class="dripicons-conversation"></i>Chat</a></li>                            
                            </ul>
                        ...
                        <li class="has-submenu">
                            ...
                            <ul class="submenu">                                    
                                ...
                                <li><a href="../hospital/leaves.html"><i class="dripicons-shopping-bag"></i>Leaves</a></li>
                                <li><a href="../hospital/holidays.html"><i class="dripicons-headset"></i>Holidays</a></li>
                                <li><a href="../hospital/attendance.html"><i class="dripicons-checkmark"></i>Attendance</a></li>                            
                            </ul>
                        </li>
